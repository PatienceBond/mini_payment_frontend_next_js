...
import { Search, CreditCard, Calendar, DollarSign, AlertCircle, Loader2 } from "lucide-react";
...
export function TransactionLookup() {
  const { getTransaction, isLoading } = useTransaction();
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            <div className="space-y-2">
              ...
              {errors.transactionId && (
                <div className="text-sm text-destructive">{errors.transactionId.message}</div>
              )}
            </div>
